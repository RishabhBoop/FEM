...
PYBIND11_MODULE(fem_cpp, m)
{
    ...
    py::class_<FEM_2D>(m, "FEM_2D")
        ...
        .def("gen_b", py::overload_cast<const Matrix&>(&FEM_2D::gen_b, py::const_), "Generate b from a matrix")
        .def("gen_b", py::overload_cast<const Vector&>(&FEM_2D::gen_b, py::const_), "Generate b from a vector")
        .def("gen_c", py::overload_cast<const Matrix&>(&FEM_2D::gen_c, py::const_), "Generate c from a matrix")
